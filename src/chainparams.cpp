...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 10 * 30; // made to 5 mins // 6 * 60 * 60; // 6 hrs // 3.5 * 24 * 60 * 60; // 3.5 days
        consensus.nPowTargetSpacing = 1 * 30; // seconds 30 // 2.5 * 60;
        ...
        // something need to be done may be this will work
...
//            }
        ...
        // vSeeds.emplace_back("seed-a.troin.loshan.co.uk", true);
        // vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.trointools.com", true);
        // vSeeds.emplace_back("dnsseed.troinpool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.trointools.com", true);
        vSeeds.emplace_back("seed-b.troin.loshan.co.uk", true);
