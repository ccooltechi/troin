...
const char * const BITCOIN_CONF_FILENAME = "troin.conf";
const char * const BITCOIN_PID_FILENAME = "troin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Troin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Troin";
#else
    // Unix
    return pathRet / ".troin";
#endif
#endif
}
