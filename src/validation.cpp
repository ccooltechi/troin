...
#if defined(NDEBUG)
# error "Troin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Troin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s TRN additional fees, %d delta bytes\n",
